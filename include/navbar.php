  ...
  <div class="container">
    ...
    <div id="navbar-collapse" class="navbar-collapse collapse">
      <ul class="nav navbar-nav navbar-left">
        <li class=<?php if($current =='index'){echo 'active';}?>><a href="index.php">Home&emsp;&emsp;&emsp;</a></li>
        <li class=<?php if($current =='food'){echo 'active';}?>><a href="food.php">Food&emsp;&emsp;&emsp;</a></li>
