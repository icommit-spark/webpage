        ...
        <div class="container">
          <div class="row">
            <div style="margin-top: 0px" class="col-md-6 col-md-offset-3 text-center section-heading probootstrap-animate">
              <h2>Meet Our Top Shopping Contributors</h2>
          ...
          $sql = "SELECT `username`, count(*) FROM `pledges` WHERE `username` IS NOT NULL and `category`='shopping' GROUP BY `username` ORDER BY count(*) DESC LIMIT 4";
